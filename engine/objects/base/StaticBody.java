...
public abstract class StaticBody extends Body {
    ...
    public StaticBody(World world, Vec2 pos) {
        this(world, pos, new Vec2(), new Vec2(), 1);
    }

    public StaticBody(World world, Vec2 pos, Vec2 vel) {
        this(world, pos, vel, new Vec2(), 1);
    }

    public StaticBody(World world, Vec2 pos, Vec2 vel, Vec2 acc) {
        this(world, pos, vel, acc, 1);
    }

    public StaticBody(World world, Vec2 pos, Vec2 vel, Vec2 acc, double mass) {
